...
void __attribute__((long_call)) CopyWindowToVram8Bit(u8 windowId, u8 mode);
...
void __attribute__((long_call)) CallWindowFunction(u8 windowId, WindowFunc func);
...
u16 __attribute__((long_call)) AddWindow8Bit(const struct WindowTemplate *template);
void __attribute__((long_call)) FillWindowPixelBuffer8Bit(u8 windowId, u8 fillValue);
