...
void __attribute__((long_call)) CloseLink(void);
u16 __attribute__((long_call)) LinkMain2(const u16 *);
void __attribute__((long_call)) ClearLinkCallback(void);
void __attribute__((long_call)) ClearLinkCallback_2(void);
u8 __attribute__((long_call)) GetLinkPlayerCount(void);
void __attribute__((long_call)) OpenLinkTimed(void);
u8 __attribute__((long_call)) GetLinkPlayerDataExchangeStatusTimed(int lower, int higher);
bool8 __attribute__((long_call)) IsLinkPlayerDataExchangeComplete(void);
u32 __attribute__((long_call)) GetLinkPlayerTrainerId(u8);
void __attribute__((long_call)) ResetLinkPlayers(void);
u8 __attribute__((long_call)) GetMultiplayerId(void);
u8 __attribute__((long_call)) BitmaskAllOtherLinkPlayers(void);
bool8 __attribute__((long_call)) SendBlock(u8, const void *, u16);
u8 __attribute__((long_call)) GetBlockReceivedStatus(void);
void __attribute__((long_call)) ResetBlockReceivedFlags(void);
void __attribute__((long_call)) ResetBlockReceivedFlag(u8);
void __attribute__((long_call)) SetLinkDebugValues(u32, u32);
u8 __attribute__((long_call)) GetSavedPlayerCount(void);
u8 __attribute__((long_call)) GetLinkPlayerCount_2(void);
bool8 __attribute__((long_call)) IsLinkMaster(void);
void __attribute__((long_call)) CB2_LinkError(void);
u8 __attribute__((long_call)) GetSioMultiSI(void);
bool8 __attribute__((long_call)) IsLinkConnectionEstablished(void);
void __attribute__((long_call)) SetSuppressLinkErrorMessage(bool8);
bool8 __attribute__((long_call)) HasLinkErrorOccurred(void);
void __attribute__((long_call)) ResetSerial(void);
u32 __attribute__((long_call)) LinkMain1(u8 *, u16 *, u16[MAX_RFU_PLAYERS][CMD_LENGTH]);
void __attribute__((long_call)) RfuVSync(void);
...
void __attribute__((long_call)) SetCloseLinkCallback(void);
void __attribute__((long_call)) OpenLink(void);
bool8 __attribute__((long_call)) IsLinkMaster(void);
void __attribute__((long_call)) CheckShouldAdvanceLinkState(void);
void __attribute__((long_call)) SetCloseLinkCallbackAndType(u16 type);
void __attribute__((long_call)) CloseLink(void);
bool8 __attribute__((long_call)) IsLinkTaskFinished(void);
bool32 __attribute__((long_call)) IsLinkRecvQueueAtOverworldMax(void);
void __attribute__((long_call)) ResetSerial(void);
void __attribute__((long_call)) SetWirelessCommType1(void);
void __attribute__((long_call)) LoadWirelessStatusIndicatorSpriteGfx(void);
void __attribute__((long_call)) CreateWirelessStatusIndicatorSprite(u8, u8);
void __attribute__((long_call)) StartSendingKeysToLink(void);
void __attribute__((long_call)) ClearLinkCallback_2(void);
void __attribute__((long_call)) Rfu_SetLinkStandbyCallback(void);
void __attribute__((long_call)) ConvertLinkPlayerName(struct LinkPlayer * linkPlayer);
bool8 __attribute__((long_call)) IsWirelessAdapterConnected(void);
bool8 __attribute__((long_call)) SendBlockRequest(u8 blockRequestType);
void __attribute__((long_call)) LinkVSync(void);
bool8 __attribute__((long_call)) HandleLinkConnection(void);
void __attribute__((long_call)) LocalLinkPlayerToBlock(void);
void __attribute__((long_call)) LinkPlayerFromBlock(u32 who);
void __attribute__((long_call)) SetLinkErrorFromRfu(u32 status, u8 lastSendQueueCount, u8 lastRecvQueueCount, u8 isConnectionError);
u8 __attribute__((long_call)) GetLinkPlayerCountAsBitFlags(void);
void __attribute__((long_call)) ResetLinkPlayerCount(void);
void __attribute__((long_call)) SaveLinkPlayers(u8 numPlayers);
u8 __attribute__((long_call)) GetSavedLinkPlayerCountAsBitFlags(void);
void __attribute__((long_call)) CheckLinkPlayersMatchSaved(void);
void __attribute__((long_call)) SetLocalLinkPlayerId(u8 playerId);
bool32 __attribute__((long_call)) IsSendingKeysToLink(void);
u32 __attribute__((long_call)) GetLinkRecvQueueLength(void);
