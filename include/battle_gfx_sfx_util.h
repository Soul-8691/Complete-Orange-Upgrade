...
void __attribute__((long_call)) BattleGfxSfxDummy3(u8 gender);
...
void __attribute__((long_call)) HandleSpeciesGfxDataChange(u8 battlerAtk, u8 battlerDef, u8 transformType);
...
bool32 __attribute__((long_call)) ShouldPlayNormalMonCry(struct Pokemon *mon);
