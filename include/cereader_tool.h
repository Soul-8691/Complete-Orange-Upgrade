...
bool32 __attribute__((long_call)) ValidateTrainerTowerData(struct EReaderTrainerTowerSet * ttdata);
bool32 __attribute__((long_call)) CEReaderTool_SaveTrainerTower(struct EReaderTrainerTowerSet * ttdata);
bool32 __attribute__((long_call)) CEReaderTool_LoadTrainerTower(struct EReaderTrainerTowerSet * ttdata);
bool32 __attribute__((long_call)) ReadTrainerTowerAndValidate(void);
