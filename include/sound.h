...
void __attribute__((long_call)) PlayCry_Normal(u16 species, s8 pan);
void __attribute__((long_call)) PlayCry_NormalNoDucking(u16 species, s8 pan, s8 volume, u8 priority);
void __attribute__((long_call)) PlayCry_ByMode(u16 species, s8 pan, u8 mode);
void __attribute__((long_call)) PlayCry_ReleaseDouble(u16 species, s8 pan, u8 mode);
